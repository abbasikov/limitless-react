...
class LosingBidContainer extends React.Component {
                ...
                <div className="page-header page-header-default">
                    <div className="page-header-content">
                        <div className="page-title">
                            <h4><i className="icon-list-unordered position-left"/> <span
                                className="text-semibold">Losing Bids</span></h4>
                        </div>
                    </div>
                    ...
                    <div className="breadcrumb-line">
                        <ul className="breadcrumb">
                            ...
                            <li>
                                <a href="javascript:void(0);">Losing Bids</a>
                            </li>
                        </ul>
                    </div>
                </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(LosingBidContainer);